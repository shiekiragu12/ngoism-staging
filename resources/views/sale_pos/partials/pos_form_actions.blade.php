...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			<button type="button" 
				class="btn bg-success btn-default btn-flat no-print @if(!empty($pos_settings['disable_suspend'])) @endif pos-express-finalize @if(!array_key_exists('mpesa', $payment_types)) hide @endif @if($is_mobile) col-xs-6 @endif" 
				data-pay_method="mpesa"
				title="@lang('M-PESA')" >
				<img height="20px" width="45px" class="float-right"
