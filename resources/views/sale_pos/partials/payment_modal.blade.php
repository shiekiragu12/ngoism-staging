	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12 mb-12">
						...
						{!! Form::hidden('advance_balance', null, ['id' => 'advance_balance', 'data-error-msg' =>
						...
						<div class="box box-solid bg-orange">
							<div class="box-body">
								...
								<div class="col-md-12">
									...
									{!! Form::hidden("change_return", $change_return['amount'], ['class' =>
									'form-control change_return input_number', 'required', 'id' => "change_return"]);
									!!}
									<!-- <span class="lead text-bold total_quantity">0</span> -->
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="pos-save">@lang('sale.finalize_payment')</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								{!! Form::select("", ['visa' => 'Visa', 'master' => 'MasterCard'], 'visa',['class' =>
			...
			<div class="modal-dialog" style="width:300px; height:300px;" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<img height="60px" class="float-right"
