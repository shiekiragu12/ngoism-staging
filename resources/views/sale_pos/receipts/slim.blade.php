		...
		<table style="margin-top: 25px !important" class="border-bottom width-100 table-f-12 mb-10">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right" style="font-size: 11px;">{{$line['product_tax']}}</td>
					<td class="quantity text-right" style="font-size: 11px;">{{$line['quantity']}}
					</td>
					@if(empty($receipt_details->hide_price))
					<!-- <td class="unit_price text-right" style="font-size: 11px;">{{$line['unit_price_before_discount']}}
					</td> -->
					@if(!empty($receipt_details->item_discount_label))
					...
					@endif
					<td class="price text-right" style="font-size: 11px;">{{$line['line_total']}}</td>
					@endif
				...
				@endforeach
				<tr>
					<td @if(!empty($receipt_details->item_discount_label)) colspan="6" @else colspan="5" @endif>&nbsp;
					</td>
				</tr>
			</tbody>
		</table>
