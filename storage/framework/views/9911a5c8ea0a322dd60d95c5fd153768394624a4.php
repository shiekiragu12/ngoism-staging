<?php if(empty($is_admin)): ?>
    <h3><?php echo app('translator')->getFromJson('business.business'); ?></h3>
<?php endif; ?>
<?php echo Form::hidden('language', request()->lang);; ?>


<fieldset>
<legend><?php echo app('translator')->getFromJson('business.business_details'); ?>:</legend>
<div class="col-md-12">
...
<!-- tax details -->
<?php if(empty($is_admin)): ?>
    <h3><?php echo app('translator')->getFromJson('business.business_settings'); ?></h3>

    <fieldset>
    <legend><?php echo app('translator')->getFromJson('business.business_settings'); ?>:</legend>
    <div class="col-md-6">
        <div class="form-group">
...
<!-- Owner Information -->
<?php if(empty($is_admin)): ?>
    <h3><?php echo app('translator')->getFromJson('business.owner'); ?></h3>
<?php endif; ?>

<fieldset>
<legend><?php echo app('translator')->getFromJson('business.owner_info'); ?></legend>
<div class="col-md-4">
    <div class="form-group">
...
<div class="clearfix"></div>
</fieldset><?php /**PATH C:\wamp64\www\ngoism-master\resources\views/business/partials/register_form.blade.php ENDPATH**/ ?>