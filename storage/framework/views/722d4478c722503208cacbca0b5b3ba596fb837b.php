                    ...
                    <?php if(!($request->segment(1) == 'business' && $request->segment(2) == 'register')): ?>
                        ...
                        <?php if(config('constants.allow_registration')): ?>
                            ...
                            <?php if(Route::has('pricing') && config('app.env') != 'demo' && $request->segment(1) != 'pricing'): ?>
                                &nbsp; <a href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\PricingController@index'), false); ?>"><?php echo app('translator')->getFromJson('superadmin::lang.pricing'); ?></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
...
</html><?php /**PATH C:\wamp64\www\ngoism-master\resources\views/layouts/auth2.blade.php ENDPATH**/ ?>