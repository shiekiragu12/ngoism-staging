...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/pos/generatepdf/{randomStr}', 'PdfController@index')->name('pdf');
    ...
    Route::get('mpesa-settings', 'MpesaController@index')->name('mpesa_settings');
    Route::post('update-mpesa-settings', 'MpesaController@updateMpesaSettings')->name('update_mpesa_settings');
